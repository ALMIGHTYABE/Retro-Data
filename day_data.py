...
#     logger.error("Error occurred during Day Data process. Error: %s" % e, exc_info=True)
...
# except Exception as e:
#     logger.error("Error occurred during Day Data Combined process. Error: %s" % e, exc_info=True)